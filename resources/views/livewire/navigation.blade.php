    ...
    <nav class="bg-gray-800 fixed top-0 inset-x-0" x-data="{ open:false }">
            ...
            <div class="relative flex items-center justify-between h-16">
                ...
                <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                  ...
                  {{ request()->routeIs('home') ? 'active' : '' }}">Inicio</a>
                            ...
                            <a href="{{ route('products.index') }}" class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium
                  {{ request()->routeIs('products.*') ? 'active' : '' }}">Productos</a>
                    ...
                    <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                        ...
                        <div class="ml-3 relative" x-data="{open:false}">
                            ...
                            <div x-show="open" x-on:click.away=" open=false "
                                ...
                                <a href="{{ route('turns.index', auth()->user()->id) }}"
        ...
        <div class="sm:hidden" x-show="open" x-on:click.away=" open=false ">
            ...
            {{ request()->routeIs('home') ? 'active' : '' }}">Inicio</a>
                ...
                <a href="{{ route('products.index') }}" class="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium
            {{ request()->routeIs('products.*') ? 'active' : '' }}">Products</a>
